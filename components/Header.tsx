          ...
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center gap-2 text-sm">
              {isAdmin && (
                <Link
                  href="/admin"
                  className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-emerald-500 to-teal-600 px-3 py-2 text-white font-medium shadow-sm transition-all hover:shadow-lg hover:scale-105 active:scale-95"
                >
                  <span className="relative z-10 text-xs">مدیریت</span>
              ...
              {user ? (
                ...
                <Link
                  href="/auth/sign-in"
                  className="group relative overflow-hidden rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-2 text-white font-medium shadow-sm transition-all hover:shadow-lg hover:scale-105 active:scale-95"
                >
        ...
        <div className="hidden md:block">
          <div className="relative flex items-center justify-between">
            ...
            <div className="flex-1 flex justify-center text-center">
              <Link href="/" className="group inline-block no-underline">
                <h1 className="text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent leading-tight transition-all group-hover:from-blue-900 group-hover:via-blue-800 group-hover:to-blue-900">
                  شرکت صنایع غذایی کوثر کویر رفسنجان
                </h1>
                <p className="text-sm lg:text-base text-gray-500 mt-2 font-medium tracking-wide transition-colors group-hover:text-gray-600">
                  سامانه ورود و تکمیل فرم‌های سازمانی
                </p>
              </Link>
            </div>
